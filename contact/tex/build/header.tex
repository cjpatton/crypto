...
\newcommand{\typefont}[1]{\cryptofont{#1}}
\newcommand{\capgreekfont}[1]{\mathrm{#1}}
\newcommand{\codefont}[1]{\lstinline|#1|}
\newcommand{\msgfont}[1]{\textsc{#1}}
\newcommand{\funcfont}[1]{\textnormal{#1}}

\def\v.#1{\vec{#1}}

% Crypto functions
\newcommand{\Exp}[1]{\cryptofont{Exp}^{{\tiny\MakeLowercase{\textnormal{#1}}}}}
\newcommand{\Adv}[1]{\cryptofont{Adv}^{{\tiny\MakeLowercase{\textnormal{#1}}}}}
...
\def\tostr(#1){\langle\hspace{0.5pt}#1\hspace{0.5pt}\rangle}
\def\toint(#1,#2){\langle\hspace{0.5pt}#2\hspace{0.5pt}\rangle_{#1}}
...
% - Inline comment
\definecolor{OldCommentColor}{RGB}{125,175,230}
\definecolor{theblue}{RGB}{85,135,170}
\definecolor{thegray}{RGB}{165,165,165}
\newcommand{\comment}[1]{\textsf{\textcolor{theblue}{\,\text{//}\,{\small #1}}}}
...
% - Line number format
\newcommand{\lifont}[1]{\textsf{\color{thegray}#1}}
...
%  \stepcounter{LineCounter}\lifont{\scriptsize\theFunctionCounter\ifnum\value{LineCounter}<10\ignorespaces0\fi\theLineCounter}
  \stepcounter{LineCounter}\makebox[6pt][r]{\lifont{\scriptsize\theLineCounter}}\hspace{2pt}
}
...
\newcommand{\fixme}[1]{\basenote{violet}{}{fix-me}{#1}}
